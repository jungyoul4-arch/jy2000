-- ============================================================
-- 일정 캘린더에 중요 플래그(is_important) 추가
-- ============================================================

USE jysk;

-- 1. schedule_event 테이블에 is_important 컬럼 추가
ALTER TABLE schedule_event
ADD COLUMN is_important TINYINT(1) DEFAULT 0 COMMENT '중요 일정 여부 (0: 일반, 1: 중요)'
AFTER content;

-- 2. v_schedule_event_detail 뷰 재생성 (is_important 포함)
