...
CREATE TABLE class_type (
    ...
    class_type_name     VARCHAR(100) NOT NULL COMMENT '반형태명 (예: 2026 고등부 과학 모의 (고1))',
    year                INT NULL COMMENT '년도 (예: 2026, 2027)',
    grade               INT NOT NULL COMMENT '학년 (9=중3, 10=고1, 11=고2, 12=고3)',
    subject             INT NOT NULL COMMENT '과목 (1=국어, 2=수학, 3=영어, 4=과학, 5=사회)',
    format              INT NULL COMMENT '형태 (1=일반, 2=종합, 3=논술, 4=모의, 5=특강, 6=썸머, 7=윈터)',
...
CREATE TABLE mgmt_data (
    ...
    price               INT DEFAULT 0 COMMENT '가격 (원, class_type.unit_price × enrollment_count)',
    student_name_orig   VARCHAR(100) NULL COMMENT '엑셀 원본 학생 이름',
    teacher_name_orig   VARCHAR(100) NULL COMMENT '엑셀 원본 강사 이름',
    class_type_name_orig VARCHAR(100) NULL COMMENT '엑셀 원본 반형태 이름',
    created_at          DATETIME DEFAULT CURRENT_TIMESTAMP COMMENT '생성일시',
...
-- ============================================================
-- 기존 테이블에 price 컬럼 추가 (마이그레이션용)
-- ============================================================
-- ALTER TABLE mgmt_data ADD COLUMN price INT DEFAULT 0 COMMENT '가격 (원, class_type.unit_price × enrollment_count)' AFTER class_type_id;
