...
-- ============================================================
-- 4. 학생 상세 정보 (student_id = user_id)
-- ============================================================
INSERT INTO student_info (
    student_id, student_name, phone, email, birth_date, gender_code, school_name, grade_code,
    guardian_name, guardian_phone, guardian_relation,
    status_code, source_code, tc_id, first_contact_date, created_by
) VALUES
-- 잠재 고객 (user_id: 3)
(3, '홍길동', '010-1234-5678', 'hong@test.com', '2012-03-15', 'GENDER_MALE', '서울초등학교', 'GRADE_ELEM_6',
 '홍어머니', '010-1234-0001', 'RELATION_MOTHER',
 'STATUS_PROSPECT', 'SOURCE_ONLINE', 1, '2026-04-25', 1),

-- 접촉 (user_id: 4)
(4, '김철수', '010-2345-6789', 'kim@test.com', '2011-07-22', 'GENDER_MALE', '강남중학교', 'GRADE_MID_1',
 '김아버지', '010-2345-0001', 'RELATION_FATHER',
 'STATUS_CONTACT', 'SOURCE_REFERRAL', 1, '2026-04-20', 1),

-- 상담 예약 (user_id: 5)
(5, '이영희', '010-3456-7890', 'lee@test.com', '2010-11-08', 'GENDER_FEMALE', '분당중학교', 'GRADE_MID_2',
 '이어머니', '010-3456-0001', 'RELATION_MOTHER',
 'STATUS_CONSULT_BOOK', 'SOURCE_CAFE', 2, '2026-04-18', 1),

-- 상담 완료 (user_id: 6)
(6, '박민수', '010-4567-8901', 'park@test.com', '2009-05-30', 'GENDER_MALE', '대치고등학교', 'GRADE_HIGH_1',
 '박어머니', '010-4567-0001', 'RELATION_MOTHER',
 'STATUS_CONSULT_DONE', 'SOURCE_BLOG', 2, '2026-04-10', 1),

-- 등록 (user_id: 7)
(7, '최지은', '010-5678-9012', 'choi@test.com', '2013-09-12', 'GENDER_FEMALE', '서초초등학교', 'GRADE_ELEM_5',
 '최아버지', '010-5678-0001', 'RELATION_FATHER',
 'STATUS_REGISTER', 'SOURCE_WALK_IN', 1, '2026-04-01', 1),

-- 재원 (user_id: 8)
(8, '정우성', '010-6789-0123', 'jung@test.com', '2012-01-25', 'GENDER_MALE', '역삼초등학교', 'GRADE_ELEM_6',
 '정어머니', '010-6789-0001', 'RELATION_MOTHER',
 'STATUS_ENROLLED', 'SOURCE_REFERRAL', 1, '2026-01-15', 1),

-- 재원 (user_id: 9)
(9, '강민지', '010-7890-1234', 'kang@test.com', '2011-04-18', 'GENDER_FEMALE', '청담중학교', 'GRADE_MID_1',
 '강어머니', '010-7890-0001', 'RELATION_MOTHER',
 'STATUS_ENROLLED', 'SOURCE_PREV_STUDENT', 2, '2026-02-01', 1),

-- 재원 (user_id: 10)
(10, '윤서준', '010-8901-2345', 'yoon@test.com', '2010-08-05', 'GENDER_MALE', '압구정중학교', 'GRADE_MID_2',
 '윤아버지', '010-8901-0001', 'RELATION_FATHER',
 'STATUS_ENROLLED', 'SOURCE_ONLINE', 3, '2025-09-01', 1),

-- 퇴원 (user_id: 11)
(11, '한소희', '010-9012-3456', 'han@test.com', '2009-12-30', 'GENDER_FEMALE', '서울고등학교', 'GRADE_HIGH_2',
 '한어머니', '010-9012-0001', 'RELATION_MOTHER',
 'STATUS_WITHDRAW', 'SOURCE_REFERRAL', 1, '2025-03-01', 1),

-- 이탈 (user_id: 12)
(12, '임재현', '010-0123-4567', 'lim@test.com', '2012-06-14', 'GENDER_MALE', '개포초등학교', 'GRADE_ELEM_6',
...
(6, 'ABC수학학원', 'ACADEMY_MATH', '수학', '2025-03-01', '2026-02-28', 12, 350000, 'LEAVE_OTHER', 'SATISFY_NORMAL', 1),
(8, '영재수학', 'ACADEMY_MATH', '수학', '2025-01-01', '2026-01-31', 13, 400000, 'LEAVE_DISSATISFY', 'SATISFY_LOW', 1),
(9, '스마트영어', 'ACADEMY_ENGLISH', '영어', '2025-06-01', '2026-01-31', 8, 300000, 'LEAVE_SCHEDULE', 'SATISFY_NORMAL', 1),
(10, '종합학원A', 'ACADEMY_COMP', '수학,영어', '2024-03-01', '2025-08-31', 18, 500000, 'LEAVE_MOVE', 'SATISFY_HIGH', 1);
...
(7, 1, '2026-04-25', 70000, 1),
(8, 2, '2026-02-01', 350000, 1);
